...
for mf = 1:length(modFreq)
    for m = 1:length(modIndex)
        ...
        str= sprintf('Azi_0.0_Elev_0.0_Type_2_RF_1000.0_RP_0.0_MD_%2.1f _RV_%1.1f _Dur_1500.wav',mindex*100,fa);
...
name = 'Azi_0.0_Elev_0.0_Type_0_RF_0.0_RP_0_MD_0.0_RV_0.0_Dur_1500.wav';
